# Copied from https://github.com/nh2/static-haskell-nix/blob/dbce18f4808d27f6a51ce31585078b49c86bd2b5/survey/default.nix
let
        ...
        haskellPackages = previousHaskellPackages.override (old: {
          overrides = final.lib.composeExtensions (old.overrides or (_: _: {})) (self: super:
            ...
            in add_integer-simple_if_needed {
              ...
              # Manually add fingerdb entry here to survey with openssl linking fix
              fingerdb = appendConfigureFlag (addStaticLinkerFlagsWithPkgconfig
                (callCabal2nix "fingerdb" ../. { }) [ final.openssl ]
                "--libs openssl") [ "-fserver-only" ];
            });
